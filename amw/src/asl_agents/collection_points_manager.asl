...
point( 1 )[ x( 50 ), y( 50 ), state( available ) ].
point( 2 )[ x( 50 ), y( 70 ), state( available ) ].
point( 3 )[ x( 50 ), y( 90 ), state( available ) ].
point( 4 )[ x( 50 ), y( 110 ), state( available ) ].
point( 5 )[ x( 50 ), y( 130 ), state( available ) ].
point( 6 )[ x( 50 ), y( 150 ), state( available ) ].
